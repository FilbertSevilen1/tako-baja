    ...
    <div class="w-full h-full">
      <div class="flex flex-col items-center py-4">
        ...
        <div class="flex flex-row py-4">
          ...
          <div class="items-top mx-6">
            <h2 id="subtitles">Alamat Perusahaan :</h2>
        ...
        <div class="flex flex-row mt-4">
          ...
          <div class="mt-2 mx-4">
            <NuxtLink
              to="https://www.linkedin.com/in/importir-coil-galvalume-06867623b/?originalSubdomain=id"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="64"
...
import "mapbox-gl/dist/mapbox-gl.css";
  ...
  const createMap = (long, lat) => {
      ...
      const map = new mapboxgl.Map({
        accessToken:
          "pk.eyJ1IjoiZXdhc2FwdXRyYTAzIiwiYSI6ImNsYm1lMXcxbDBoMnUzcHBxZDlobGluZzgifQ.0YsmAN-CbT0tRFSZIRFuhw",
        container: "map",
        style: "mapbox://styles/mapbox/streets-v12",
        minzoom: 5,
        center: [long, lat], // use initial data as default
        zoom: 10,
      });
...
.mapboxgl-marker {
  ...
  height: 50px;
  border-radius: 50%;
  background-image: url("https://icon-library.com/images/map-pinpoint-icon/map-pinpoint-icon-13.jpg");
