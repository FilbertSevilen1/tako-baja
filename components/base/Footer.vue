<template>
  <div class="w-full background-footer">
    <div class="container w-full flex flex-col items-center text-white py-12">
      <div class="w-full font-bold text-2xl md:text-3xl mb-12">
        PT TAKO BAJA PRIMA
      </div>
      <div class="w-full flex justify-between flex-wrap">
        ...
        <div class="w-80 text-l md:text-xl mb-12">
          Untuk Permintaan Kebutuhan, Hubungi Tim Marketing Kami<br />
      ...
      <div class="w-full mt-12 md:mt-8">
        © PT Tako Baja Prima 2024
      </div>
    </div>
  </div>
</template>
